  ...
  async (req, res) => {
    ...
    if (req.method !== "POST") { res.status(405).json({ error: "Method not allowed" }); return; }
      ...
      const SYSTEM = {
        ...
        analisar_indicadores: `Voc\u00ea \u00e9 especialista em an\u00e1lise de desempenho e indicadores de processos da administra\u00e7\u00e3o p\u00fablica.\nO payload pode conter um campo "nota_sisplan" com instru\u00e7\u00f5es sobre a conven\u00e7\u00e3o de preenchimento, e um array "indicadores". Indicadores com "aguardando_fechamento": true est\u00e3o nos 2 primeiros meses de um trimestre com realizado=0 porque o SISPLAN registra resultados somente no \u00faltimo m\u00eas do trimestre (mar\u00e7o, junho, setembro ou dezembro) — IGNORE esses indicadores na an\u00e1lise de desempenho, n\u00e3o os trate como ruins nem os mencione negativamente.\nCom base nos demais indicadores, gere um coment\u00e1rio anal\u00edtico conciso (m\u00e1ximo 150 palavras) destacando:\n- Indicadores que merecem aten\u00e7\u00e3o (abaixo da meta)\n- Tend\u00eancias positivas\n- Recomenda\u00e7\u00e3o principal\nRetorne APENAS o texto do coment\u00e1rio, sem t\u00edtulo, sem markdown.`,
